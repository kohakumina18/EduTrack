...
CREATE TABLE LOP (
    ...
    CONSTRAINT FK_AssignedTeacherID FOREIGN KEY (AssignedTeacherID) REFERENCES GIAOVIEN(TeacherID)
);
...
CREATE TABLE BANDIEMDANH (
    ...
    CONSTRAINT FK_StudentID_Attendance FOREIGN KEY (StudentID) REFERENCES HOCSINH(StudentID)
);
...
CREATE TABLE BANGDIEM (
    ...
    CONSTRAINT FK_StudentID_Grade FOREIGN KEY (StudentID) REFERENCES HOCSINH(StudentID)
);
